...
<head>
    ...
    <form>
            ...
            <div class="row mb-3"><!-- $status -->
                <label align="center" class="col-sm-2 col-form-label">Status:</label>
                    <div class="col-sm-2">
            ...
            <div class="row mb-3"> <!-- $name  -->
                <label align="center" class="col-sm-2 col-form-label">Name:</label>
                    <div class="col-sm-3">
            ...
            <div class="row mb-3"><!-- $mail -->
                <label align="center" class="col-sm-2 col-form-label">E-mail:</label>
                    <div class="col-sm-3">
            ...
            <div class="row mb-3"><!-- $phone -->
                <label align="center" class="col-sm-2 col-form-label">Phone:</label>
                    <div class="col-sm-2">
                        <input class="form-control" type="text">
                    </div>
            </div>
            ...
            <div class="row mb-3"><!-- $CEP -->
                <label align="center" class="col-sm-2 col-form-label">CEP:</label>
                    <div class="col-sm-2">
                        <input class="form-control" type="text">
                    </div>
            </div>
            ...
            <div class="row mb-3"><!-- $socialweb -->
                <label align="center" class="col-sm-2 col-form-label">Social Web:</label>
                <div class="col-sm-3">
            ...
            <div class="row mb-3"><!-- $foundation / $born  -->
                <label align="center" class="col-sm-2 col-form-label">Born/Foundation:</label>
                    <div class="col-sm-2">
            ...
            <div class="row mb-0"><!-- $marital_status -->
                <fieldset class="row mb-3"> 
                    <legend align="center" class="col-form-label col-sm-2 pt-0">Marietal Status:</legend>
                        <div class="col-sm-10">
                            <div class="form-check">
            ...
            <div class="row mb-0"><!-- $gender -->
                <fieldset class="row mb-3"> 
                    <legend align="center" class="col-form-label col-sm-2 pt-0">Gender:</legend>
                        <div class="col-sm-10">
                            <div class="form-check">
            ...
            <div class="row mb-3"><!-- $RG -->
                <label align="center" class="col-sm-2 col-form-label">RG:</label>
                    <div class="col-sm-2">
                        <input class="form-control" type="text">
                    </div>
            </div>
            ...
            <div class="row mb-3"><!-- $PIS -->
                <label align="center" class="col-sm-2 col-form-label">PIS:</label>
                    <div class="col-sm-2">
                        <input class="form-control" type="text">
                    </div>
            </div>
            ...
            <div class="row mb-3"><!-- $profession -->
                <label align="center" class="col-sm-2 col-form-label">Profession:</label>
                    <div class="col-sm-2">
                        <input class="form-control" type="text">
                    </div>
            </div>
            ...
            <div class="row mb-3"><!-- $CNAE -->
                <label align="center" class="col-sm-2 col-form-label">CNAE:</label>
                    <div class="col-sm-2">
                        <input class="form-control" type="text">
                    </div> 
            </div>
            ...
            <div class="row mb-3"><!-- $schooling -->
                <label align="center" class="col-sm-2 col-form-label">Schooling:</label>
                    <div class="col-sm-2">
                        <select class="form-select">
                            <option selected>Choose...</option>
